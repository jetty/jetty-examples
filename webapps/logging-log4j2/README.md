# Log4j 2.x Logging and ErrorHandling with Jetty
...
``` shell
$ cd ~/tmp
$ curl -O http://central.maven.org/maven2/org/eclipse/jetty/jetty-home/12.0.22/jetty-home-12.0.22.tar.gz
$ tar -zxvf jetty-home-12.0.22.tar.gz
```

Using the above directories as an example, that means your `$JETTY_HOME` is  
now `$HOME/tmp/jetty-home-12.0.22/`
